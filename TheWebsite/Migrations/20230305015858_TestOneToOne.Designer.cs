...
namespace TheWebsite.Migrations
{
    ...
    [Migration("20230305015858_TestOneToOne")]
    partial class TestOneToOne
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TheWebsite.Models.Utilisateur", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UtilisateurId = new Guid("ddfb06ae-6499-4dc5-88db-43b27620933a"),
                            IsVendor = false,
                            LastName = "nom1",
                            Name = "prenom1",
                        ...
                        new
                        {
                            UtilisateurId = new Guid("81502143-62b3-446c-b172-f963e28d4ec4"),
                            IsVendor = true,
                            LastName = "nom2",
                            Name = "prenom2",
                            PasswordHash = "motdepasse",
            ...
            modelBuilder.Entity("TheWebsite.Models.Facture", b =>
                {
                    b.HasOne("TheWebsite.Models.ProduitPanier", "ProduitPanier")
                        .WithMany()
                        .HasForeignKey("ProduitPanierId")
            ...
            modelBuilder.Entity("TheWebsite.Models.Produit", b =>
                {
                    b.HasOne("TheWebsite.Models.ProduitPanier", null)
                        .WithMany("Produits")
                        .HasForeignKey("ProduitPanierId");
                });
