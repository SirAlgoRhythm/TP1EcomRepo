...
namespace TheWebsite.Migrations
{
    ...
    [Migration("20230302015901_AjoutUtilisateurIdDansProduit")]
    partial class AjoutUtilisateurIdDansProduit
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("TheWebsite.Models.Utilisateur", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UtilisateurId = new Guid("12ade67d-6880-493e-8df3-59c13e0f0857"),
                            IsVendor = false,
                            LastName = "nom1",
                            Name = "prenom1",
                        ...
                        new
                        {
                            UtilisateurId = new Guid("7bd3ac5d-06eb-4ff9-9b49-680d490b41b1"),
                            IsVendor = true,
                            LastName = "nom2",
                            Name = "prenom2",
                            PasswordHash = "motdepasse",
